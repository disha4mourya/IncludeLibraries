...
public class ShowJokes extends AppCompatActivity {
    ...
    public void getDataFromIntent() {
        ...
        splitedJokes = jokePassed.split(getString(R.string.split_key));
        setDataOnCards();
    }

    public void setDataOnCards() {
        mCardView = findViewById(R.id.view);
        mAdapter1 = new CardAdapter(splitedJokes);
        mAdapter2 = new CardAdapter(splitedJokes);
        mCardView.setAdapter(mAdapter1);
        mCardView.setCardAnimationListener(new InfiniteCardView.CardAnimationListener() {
            @Override
            public void onAnimationStart() {
                Toast.makeText(ShowJokes.this, "Animation Start", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAnimationEnd() {
                Toast.makeText(ShowJokes.this, "Animation End", Toast.LENGTH_SHORT).show();
            }
        });
        initButton();
    }
